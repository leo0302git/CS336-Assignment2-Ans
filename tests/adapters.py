...
import torch
from cs336_systems.flash_forward import MyFlashAttnAutogradFunctionClass, MyTritonFlashAttentionAutogradFunctionClass
...
from cs336_systems.optimizer_state_sharding import ShardedStateOptimizer
...
def ddp_individual_parameters_on_after_backward(ddp_model: torch.nn.Module, optimizer: torch.optim.Optimizer):
    ...
    """
    assert isinstance(ddp_model, DDPIndividualParameters)
...
def ddp_bucketed_on_after_backward(ddp_model: torch.nn.Module, optimizer: torch.optim.Optimizer):
    ...
    Args:
        ...
        optimizer: torch.optim.Optimizer
            Optimizer being used with the DDP-wrapped model.
    """
    assert isinstance(ddp_model, DDPBucketed)
    ddp_model.finish_gradient_synchronization()
